...
const MeterialsName = function (options, callback) {
  ...
  return new Promise((resolve, reject) => { // eslint-disable-line
    currentMsg = {
      options: Object.assign({}, defaults, MeterialsName.defaults, options),
      callback: callback,
      resolve: resolve,
      reject: reject
    }
...
// 设置默认配置
MeterialsName.setDefaults = defaults => {
  MeterialsName.defaults = defaults
}

// 显示弹框
MeterialsName.show = (title, options) => {
  ...
  return MeterialsName(Object.assign({
    title: title
  }, options))
}
// 手动关闭弹框
...
export default MeterialsName
export { MeterialsName }
